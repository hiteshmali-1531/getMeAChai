...
const Login = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl md:py-14 py-8 px-4 text-center container mx-auto text-white  ">Login/Signup to Get your fans to support you</h1>
            <div className="social-login-buttons flex justify-center">
